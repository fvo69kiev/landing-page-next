...
const data = [
  ...
  },
  {
    id: `${Delivery}`,
    title: 'доставка',
    text: 'Транспортировка морского контейнера контейнеровозом к месту строительства дома',
  },
  {
    id: `${Preparing}`,
    title: 'подготовка',
  ...
  },
  {
    id: `${Opening}`,
    title: 'проемы',
    text: 'Вырезание проемов под двери и окна (вентиляцию). Укрепление проемов навариванием закладных',
  },
  {
    id: `${Lathing}`,
    title: 'обрешетка',
    text: 'Установка на каркас контейнера обрешетки брусом 25х50 мм, пропитанным антисептиком',
  },
  {
    id: `${Electricity}`,
    title: 'электромонтаж',
    text: 'Устройство и разводка электропроводки многожильным проводом 2,5 мм сечения',
  },
  {
    id: `${Spray}`,
    title: 'утепление',
    text: 'Утепление каркаса контейнера напылением пенополиуретаном толщиной 50 мм',
  },
  {
    id: `${Plumbing }`,
    title: 'сантехника',
    text: 'Устройство и разводка холодного, горячего водоснабжения и канализации',
  },
  {
    id: `${Floor}`,
    title: 'теплый пол',
    text: 'Устройство теплого пола из сшитого полиэтилена. Заливка бетоном',
  },
  {
    id: `${Tiles}`,
    title: 'плитка',
  ...
  },
  {
    id: `${PaintRoller}`,
    title: 'фасад',
    text: 'Окраска фасада высококачественной краской с добавлением...',
  },
  {
    id: `${Door}`,
    title: 'дверь',
  ...
  },
  {
    id: `${Fan}`,
    title: 'вентиляция',
    text: 'Обустройство приточной системы вентиляции, установка кондиционера',
  },
  {
    id: `${Ceiling}`,
    title: 'потолок',
    text: 'Крепление к потолку ОСБ. Монтаж подвесных потолков, установка пластиковых наличников',
  },
  {
    id: `${Window}`,
    title: 'окна',
  ...
  },
  {
    id: `${Heating}`,
    title: 'отопление',
    text: 'Установка конвекторов для тепла. Монтаж адаптеров для подключения к внешним коммуникациям',
  },
  {
    id: `${Furniture}`,
    title: 'отделка',
    text: 'Отделка дома в стиле минимализма, используя мебель-трансформер',
  },
  {
    id: `${HouseHand}`,
    title: 'готовность',
